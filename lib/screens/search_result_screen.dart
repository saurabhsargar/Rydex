...
class _SearchResultScreenState extends State<SearchResultScreen> with SingleTickerProviderStateMixin {
    ...
    try {
      ...
      final rides = snapshot.docs
          .where((doc) {
            ...
            final rideDate = rideDateStr != null ? DateTime.tryParse(rideDateStr) : null;
  ...
  Future<void> _bookRide(BuildContext context, Map<String, dynamic> ride, int index) async {
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: ElevatedButton(
                                            onPressed: _isBooking && _bookingIndex == index
                                                ? null
                                                : () => _bookRide(context, ride, index),
                                            style: ElevatedButton.styleFrom(
                                              backgroundColor: Colors.teal.shade600,
                                              foregroundColor: Colors.white,
                                              padding: const EdgeInsets.symmetric(vertical: 12),
                                            ...
                                            child: _isBooking && _bookingIndex == index
                                                ? SizedBox(
                                                    width: 20,
                                                    height: 20,
                                                    child: CircularProgressIndicator(
